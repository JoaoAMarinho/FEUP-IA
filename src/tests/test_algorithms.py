...
class TestAlgorithms(unittest.TestCase):
    ...
    def test_simulated_annealing(self):
        ...
        solution = simulated_annealing.execute(self.callback,f'simulated_annealing3.json')
        print("Sim\n",solution, "Eval: ",solution.evaluation, " Time: ",solution.time)

    def test_genetic(self):
        genetics = GeneticAlgorithm(self.solution)
        solution = genetics.execute(self.callback, f'genetic3.json')
    ...
    def test_hill_climbing(self):
        ...
        solution = hill_climbing.execute(
            self.callback, f'hill_climbing3.json')
        print("Hill\n", solution, "Eval ", solution.evaluation)

    def test_tabu_search(self):
        tabu_search = TabuSearch(self.solution)
        solution = tabu_search.execute(self.callback,f'tabu_search3.json')
        print("Tabu\n", solution, "Eval ", solution.evaluation)
